 ...
 */
public class Plane2 extends Geometry {
	 ...
	 */
	public Plane2(Point3D pointOnPlane, Vector v) {
	 ...
	 */
	public Plane2(Color col, Point3D pointOnPlane, Vector v) {
		this.pointOnPlane = pointOnPlane;
		this.normal = v.normalize();
		this.emmission = col;
	}
	 ...
	 * @param p3 3rd point
	 */
	public Plane2(Point3D p1, Point3D p2, Point3D p3) {
